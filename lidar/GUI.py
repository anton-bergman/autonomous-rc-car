...
class UserInterface:
    ...
    def __init__(self):
        ...
        # Load, scale and rotate the car image
        self.racing_car = pygame.image.load("racing_car.png")
        self.racing_car = pygame.transform.scale(self.racing_car, (112, 75))
        self.racing_car = pygame.transform.rotate(self.racing_car, 90)
        ...
        # init variables for displaying the dashboard
        self.font_size = 17
    ...
    def display_dash_board(self):
        dash_board = [f"Hastighet: {self.velocity} km/h",
                      ...
                      f"Nästa konpar: {self.next_conepair}"]
    ...
    def update_dash_board(self, dash_board_list):
        ...
        self.next_conepair = dash_board_list[5]
    ...
    def draw_cones(self, cone_data):
        ...
        for cone in cone_list:
            ...
            x_coord = self.MID_X + side * \
                math.cos(math.radians(deg)) * dist / 5

            # siffran 120 var 60 tidigare, gör det skillnad? tror ej
            y_coord = self.HEIGHT - 120 - \
                math.sin(math.radians(deg)) * dist / 5

            radius = 10
            if cone_type == "BIG":
                radius = 20
            if x_coord < 2 * self.MID_X:
                pygame.draw.circle(self.display, self.green,
    ...
    def GUI_loop(self, input_string):
        ...
        # self.draw_car()
        self.display.blit(
            self.racing_car, (self.MID_X - 37, self.HEIGHT - 112))
        ...
        for event in pygame.event.get():
            ...
            # check if the "changed_mode"-button has been pressed
